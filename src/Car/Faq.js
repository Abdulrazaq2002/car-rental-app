...
import "../Style/FaqPage.css"; // Import the CSS file
      ...
      <div className='faq-container'>
        ...
        {faqs.map((faq, index) => (
          <div
            ...
            key={index}>
            <h2 className='question' onClick={() => handleQuestionClick(index)}>
              {faq.question}
